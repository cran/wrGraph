...
The function _image()_ from the graphic-package provides basic help. Such an output can be referred to as heatmap. The function _imageW()_ from this package offers convenient options for displaying row- and column-names.
...
Heatmaps are well known for displaying the results of hierarchical clustering, see also for example _heatmap()_ (stats-package) or _heatmap.2()_ from the [gplots-package](https://CRAN.R-project.org/package=wrMisc). In these case rows and columns of the data also get reorganized and dendrograms attached.
...
The author wants to acknowledge the support by the [IGBMC](http://www.igbmc.fr/) (CNRS UMR 7104, Inserm U 1258, UdS), [CNRS](http://www.cnrs.fr/), [Universit&eacute; de Strasbourg](https://www.unistra.fr) and [Inserm](https://www.inserm.fr/) and of course all collegues from the [IGBMC proteomics platform](http://proteomics.igbmc.fr/).
...
This package is constantly evolving, new functions will be added to the next version.
