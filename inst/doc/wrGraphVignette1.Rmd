...
this package, all are available from [CRAN](https://cran.r-project.org/).
...
The function in this package is a modified version of the function avaialble in [vioplot](https://CRAN.R-project.org/package=vioplot).
...
In the case of the iris-data, there are no NAs and thus n is constant, thus it will be displayed only once. 
But when working with data-sets containing NAs, or simply with lists the final n may vary.
...
For this example suppose the iris-data were organized as 10 sets of 5 measures each.
